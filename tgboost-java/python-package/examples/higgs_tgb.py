...
file_output = "/home/wepon/PycharmProjects/tgb4j/examples/output.txt"
...
tgb.run(file_training, file_validation, file_testing, file_output, early_stopping_rounds, maximize, eval_metric,
